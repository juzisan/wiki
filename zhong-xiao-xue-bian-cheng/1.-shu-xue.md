...
$$\frac{6 x^2-12 x y+6 y^2}{3 x-3 y}$$
...
$$\frac{(a-1) \left(a^2-4 a+4\right)}{\left(a^2-4\right) \left(a^2-2 a+1\right)}$$
...
$$\frac{1}{2}+\frac{1}{2\times 3}+\frac{1}{3\times 4}+\frac{1}{4\times  5}+\cdots +\frac{1}{(n-1) n}+\frac{1}{n (n+1)}=$$
