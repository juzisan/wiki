...
**_显示输出：$$x=-2\lor x=-1\lor x=0\lor x=1\lor x=2\lor x=3\lor x=4$$_**



## 4.**中学八年级上**

**_计算：$$(x+y) \left(x^2-x y+y^2\right)$$_**
...
**_计算：$$8 a^3 b^2+12 a b^3 c$$_**

```mathematica
Factor[8 a^3 b^2 + 12 a b^3 c]
```

**_显示输出：$$4 a b^2 \left(2 a^2+3 b c\right)$$_**



**_计算：$$\frac{6 x^2-12 x y+6 y^2}{3 x-3 y}$$_**
...
**_计算：$$\frac{(a-1) \left(a^2-4 a+4\right)}{\left(a^2-4\right) \left(a^2-2 a+1\right)}$$_**

```mathematica
Factor[Simplify[((-1 + a) (4 - 4 a + a^2))/((-4 + a^2) (1 - 2 a + a^2))]]
```

**_显示输出：$$\frac{a-2}{(a-1) (a+2)}$$_** 
...
**_显示输出：$$\frac{4 p}{(2 p-3 q) (2 p+3 q)}$$_** 



**_计算：$$\frac{1}{2}+\frac{1}{2\times 3}+\frac{1}{3\times 4}+\frac{1}{4\times  5}+\cdots +\frac{1}{(n-1) n}+\frac{1}{n (n+1)}=$$_** 
...
当$$x$$是怎样的实数时，$$\sqrt{x-2}$$在实数范围内有意译？
